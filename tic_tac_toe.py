''' This is the most basic project fie.
    This file contains the random logic to put on computer's moves
'''
...
def display_photo(n, m, p):  # func for changing block image
    global user_loc
...
def comp_response():
    ...
    for i in arrangements:
        ...
        if r == 3:
            ...
            # print(t)
            win(t, 1)
            Label(button_frame, image=you_win, borderwidth=0).grid(row=0, column=0, columnspan=3, rowspan=2)
            con = 1
        else:
            pass
    if con != 1:
        ...
        if temp_list:
            ...
            for f in arrangements:
                ...
                if h == 3:
                    ...
                    # print(z)
                    win(z, 2)
                    Label(button_frame, image=you_lose, borderwidth=0).grid(row=0, column=0, columnspan=3,rowspan=2)
                else:
                    pass
        else:
            pass
...
def win(b, o):
    ...
    #Button(button_frame, image=reset_button, borderwidth=0).grid(row=2, column=1, columnspan=1, rowspan=1)
    # ans = input("enter")
    # if ans == "y":
    #     n = 1
...
btn1 = Button(button_frame, width=155, height=155, image=photo, bd=0, \
              cursor="hand2", command=lambda: [display_photo(0, 0, 1), comp_response()]).grid(row=0, column=0, padx=2,
                                                                                              pady=2)
btn2 = Button(button_frame, width=155, height=155, image=photo, bd=0, \
              cursor="hand2", command=lambda: [display_photo(0, 1, 1), comp_response()]).grid(row=0, column=1, padx=2,
                                                                                              pady=2)
btn3 = Button(button_frame, width=155, height=155, image=photo, bd=0, \
              cursor="hand2", command=lambda: [display_photo(0, 2, 1), comp_response()]).grid(row=0, column=2, padx=2,
                                                                                              pady=2)
btn4 = Button(button_frame, width=155, height=155, image=photo, bd=0, \
              cursor="hand2", command=lambda: [display_photo(1, 0, 1), comp_response()]).grid(row=1, column=0, padx=2,
                                                                                              pady=2)
btn5 = Button(button_frame, width=155, height=155, image=photo, bd=0, \
              cursor="hand2", command=lambda: [display_photo(1, 1, 1), comp_response()]).grid(row=1, column=1, padx=2,
                                                                                              pady=2)
btn6 = Button(button_frame, width=155, height=155, image=photo, bd=0, \
              cursor="hand2", command=lambda: [display_photo(1, 2, 1), comp_response()]).grid(row=1, column=2, padx=2,
                                                                                              pady=2)
btn7 = Button(button_frame, width=155, height=155, image=photo, bd=0, \
              cursor="hand2", command=lambda: [display_photo(2, 0, 1), comp_response()]).grid(row=2, column=0, padx=2,
                                                                                              pady=2)
btn8 = Button(button_frame, width=155, height=155, image=photo, bd=0, \
              cursor="hand2", command=lambda: [display_photo(2, 1, 1), comp_response()]).grid(row=2, column=1, padx=2,
                                                                                              pady=2)
btn9 = Button(button_frame, width=155, height=155, image=photo, bd=0, \
              cursor="hand2", command=lambda: [display_photo(2, 2, 1), comp_response()]).grid(row=2, column=2, padx=2,
                                                                                              pady=2)
